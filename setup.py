...
try:
    ...
    LONG_DESCRIPTION = ('Helpik is microservice intended to '
                        'gather synopses from CusDeb Wiki '
...
setup(name='helpik',
      ...
      author='Dmitry Ivanko, Vladislav Yarovoy',
      author_email='tmwsls12@gmail.com, vlad_yarovoy_97@mail.ru',
